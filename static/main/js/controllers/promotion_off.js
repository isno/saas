var PromotionOffController = BaseEditController.extend({
    _tag: "promotion",
    _tagEdit: "promotionoff",
    _tagCn: "满减活动",
    ...
    _initRangeType: function () {
        ...
        t.rangeTypes = YouPreset.DISCOUNT_RANGE_TYPE, t.isRangeTypeChecked = function (e) {
            ...
            i.products({
                ...
                onDone: function (i) {
                    t.unSaved(), t.data.products = i, i.length > 0 && (t.validation.toggle("products", !1), e._checkPromotionAvail(JSON.stringify(i)))
                }
            })
        }
        ...
        }, e.blurOff = function (i, n) {
            parseFloat(i.discount_amount) > parseFloat(i.active_amount) && t(function () {
                e.validation.toggle("discountAmount_" + n, !0, "减免金额必须小于或等于满减金额")
            }, 200)
        }
    ...
    onInitDone: function (e) {
        var t = this._$scope,
            i = this._$Time;
        t.data = e, 
        e.promotion_offs && 0 !== e.promotion_offs.length || (e.promotion_offs = [{}]), 
        _.forEach(e.promotion_offs, function (e) {
            e.active_amount /= 100, e.discount_amount /= 100
        });
        var n = 0;
    ...
    checkRule: function () {
        ...
        return t(function (e, t) {
            ...
            t(function (t, a) {
                Number(t.active_amount) < Number(i.active_amount) && Number(t.discount_amount) >= Number(i.discount_amount) && (n = !1, e.validation.toggle("discountAmount_" + a, !0, '与"满' + i.active_amount + "减" + i.discount_amount + '"规则冲突，减免金额应小于' + i.discount_amount))
            })
        }), n
        ...
        _.forEach(e.data.promotion_offs, function (e, t) {
            n.push("activeAmount_" + t), n.push("discountAmount_" + t)
        }), e.validation.validate(n) || (t = !1, i = !0), _.forEach(e.data.promotion_offs, function (n, a) {
            parseFloat(n.discount_amount) > 0 && parseFloat(n.active_amount) > 0 && parseFloat(n.discount_amount) > parseFloat(n.active_amount) && (e.validation.toggle("discountAmount_" + a, !0, "减免金额必须小于或等于满减金额", !i), t = !1, i = !0)
        }), this.checkRule() || (t = !1);
    ...
    onSave: function (e) {
        var t = this._$scope,
            i = this._$Time,
            n = this._$Util;
        if (e.id = t.data.id, e.name = t.data.name, e.introduce = t.data.introduce, e.active_type = t.data.active_type, e.range_type = t.data.range_type, e.discount_type = "amount_off", "partial" == t.data.range_type && t.data.products.length > 0) {
            var a = [];
        ...
        _.forEach(t.data.promotion_offs, function (e) {
            s.push({
                ...
                discount_amount: n.fen(e.discount_amount)
            })
...
PromotionOffController.$inject = ["$scope", "$rootScope", "$Popup", "$Uri", "$timeout", "$Time", "$Util"];