var youCalendarDirective = BaseController.extend({
    _tempMoment: null,
    _tempTime: null,
    _format: null,
    init: function(e, t, i, n) {
        ...
        e.monthSub = function() {
            if (a._tempMoment.subtract("M", 1), a._tempMoment.year() < 2e3) return void a._tempMoment.add("M", 1);
            a._updateDates()
        },
        e.monthAdd = function() {
            if (a._tempMoment.add("M", 1), a._tempMoment.year() > 2100) return void a._tempMoment.subtract("M", 1);
            a._updateDates()
        },
        e.yearSub = function() {
            if (a._tempMoment.subtract("y", 1), a._tempMoment.year() < 2e3) return void a._tempMoment.add("y", 1);
            a._updateDates()
        },
        e.yearAdd = function() {
            if (a._tempMoment.add("y", 1), a._tempMoment.year() > 2100) return void a._tempMoment.subtract("y", 1);
            a._updateDates()
        },
...
angular.module("directives.youCalendar", []).directive("youCalendar", ["$Time",function(e) {
    return {
        restrict: "E",
        scope: {
            data: "="
