var youAreaselectorDirective = BaseController.extend({
    init: function (e, t, i, n, a, o, s, r) {
        ...
        var d = !0,
            p = function (t) {
                if (t + "")
                    for (var i = t + 1, n = i; n <= 2; n++) u(n, !1);
                e.data.result = ""
            },
            u = function (t, i) {
                e.AREA_SELECTOR[t].show = i
            },
            m = function (t) {
                e.data.result = t
            };
        e.onSelChange = function (t) {
            var i = e.AREA_SELECTOR[t].selectedArea.code;
            2 === t ? i && m(i) : (p(t), g(t + 1, i))
        };
        var g = function (t, i, n) {
                if ("0" === i) return void(d || (t > 0 ? m(e.AREA_SELECTOR[t - 1].selectedArea.code) : p()));
                var a;
                switch (t) {
                case 0:
                    f(l, t, n);
                    break;
                case 1:
                    a = h(i), 1 === a.length ? (u(t, !1), g(t + 1, a[0][0])) : f(a, t, n);
                    break;
                case 2:
                    a = h(i), 0 === a.length ? m(i) : f(a, t, n)
                }
                d || m(i)
            },
            f = function (t, i, n) {
                var a = [],
                    o = {
                        parent: "",
                        name: YouPreset.AREA_SELECTOR[i],
                        code: "0"
                    };
                a.push(o), e.AREA_SELECTOR[i].selectedArea && delete e.AREA_SELECTOR[i].selectedArea, _.forEach(t, function (t) {
                    var o = {};
                    o.parent = t[2], 
                    o.name = t[1], 
                    o.code = t[0], 
                    a.push(o), 
                    n == t[0] && (e.AREA_SELECTOR[i].selectedArea = o)
                }), 
                e.AREA_SELECTOR[i].selectedArea || (e.AREA_SELECTOR[i].selectedArea = o), 
                e.AREA_SELECTOR[i].areas = a, 
                u(i, !0)
            },
            h = function (e) {
                var t = [];
                return _.forEach(c, function (i) {
                    i[2] == e && t.push(i)
                }), t
            },
            v = function (e) {
                var t = {};
                return _.forEach(c, function (i, n) {
                    if (i[0] == e) return t.district = i, !1
                }), t.district ? (_.forEach(c, function (e, i) {
                    if (e[0] == t.district[2]) return t.city = e, !1
                }), t.city || (t.city = t.district, delete t.district), _.forEach(l, function (e, i) {
                    if (e[0] == t.city[2]) return t.province = e, !1
                }), t) : (_.forEach(l, function (i, n) {
                    if (i[0] == e) return t.province = i, !1
                }), t)
            },
            y = function () {
                e.extCls = e.data.extCls, 
                void 0 !== e.data.fullSelect && (d = e.data.fullSelect);
                var t = e.data.initCode;
                if (t && "0" != t) {
                    var i = v(t);
                    i.province && i.province[0] && (g(0, "", i.province[0]), d || e.onSelChange(0)), 
                    i.city && i.city[0] && (g(1, i.province[0], i.city[0]), d || e.onSelChange(1)), 
                    i.district && i.district[0] && g(2, i.city[0], i.district[0]), 
                    m(t)
                } else g(0);
                e.data.detail = e.AREA_SELECTOR
            },
            b = !1;
...
angular.module("directives.youAreaselector", []).directive("youAreaselector", ["$Uri", "$timeout", "$document", "$compile", "$Popup",
    function (e, t, i, n, a) {
        return {
            restrict: "E",
            scope: {
            ...
            link: function (o, s, r) {
                new youAreaselectorDirective(o, s, r, e, t, i, n, a)
            }, replace: !0,
            template: '<span ng-repeat="a in AREA_SELECTOR"><select ng-show="a.show" class="{{ $parent.extCls }}" ng-model="a.selectedArea" ng-options="i.name for i in a.areas" ng-change="$parent.onSelChange({{$index}})"></select> <span ng-show="a.show"></span></span> '
        }
    }
]);